...
class Transaction : 
    ...
    def validate_dictionary(self) : 
        ...
        for  item_name in self.transaction_dict.keys() : 
            #typechecking 
            if self.transaction_dict[item_name]['item_amt'].isnumeric() == False or self.transaction_dict[item_name]['price_per_item'].isdecimal() == False : 
                raise ValueError(f'Terdapat kesalahan input pada jumlah barang ,jumlah barang harus angka')
    ...
    def add_item(self,item_name:str,item_amount:int,price_per_item:float) : 
        ...
        #Add Transaction 
        self.transaction_dict[item_name] = {'item_name':item_name,'item_amt': item_amount,
